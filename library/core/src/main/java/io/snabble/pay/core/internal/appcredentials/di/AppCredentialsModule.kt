package io.snabble.pay.core.internal.appcredentials.di
...
import io.snabble.pay.core.internal.appcredentials.data.source.local.LocalRuntimeAppCredentialsDataSourceImpl
...
val appCredentialsModule = module {
    factory { GetAppCredentialsUseCase(get<AppCredentialsRepositoryImpl>()::getAppCredentials) }
